...
-- CreateEnum
CREATE TYPE "StoryType" AS ENUM ('PHOTO', 'VIDEO', 'TEXT');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FOLLOW', 'FOLLOW_REQUEST', 'FOLLOW_ACCEPTED', 'LIKE_POST', 'LIKE_REEL', 'COMMENT', 'COMMENT_REPLY', 'MENTION', 'STORY_REACTION', 'MESSAGE', 'POST_SHARE');
...
CREATE TABLE "Reel" (
    ...
    "caption" TEXT,
    "audioTitle" TEXT DEFAULT 'Original Audio',
    "audioArtist" TEXT,
...
-- CreateIndex
CREATE INDEX "Reel_createdAt_idx" ON "Reel"("createdAt" DESC);
...
-- CreateIndex
CREATE UNIQUE INDEX "StoryReaction_storyId_userId_reaction_key" ON "StoryReaction"("storyId", "userId", "reaction");
...
-- CreateIndex
CREATE UNIQUE INDEX "CollectionItem_collectionId_postId_key" ON "CollectionItem"("collectionId", "postId");
