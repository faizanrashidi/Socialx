...
exports.messagesRouter.get('/conversations', auth_middleware_1.authenticateToken, async (req, res) => {
    try {
...
exports.messagesRouter.post('/conversations', auth_middleware_1.authenticateToken, async (req, res) => {
    try {
...
exports.messagesRouter.get('/conversations/:id/messages', auth_middleware_1.authenticateToken, async (req, res) => {
    try {
...
exports.messagesRouter.post('/conversations/:id/messages', auth_middleware_1.authenticateToken, async (req, res) => {
    try {
        const userId = req.user.userId;
        const conversationId = req.params.id;
